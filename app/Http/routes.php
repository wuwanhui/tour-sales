    ...
    Route::group(['middleware' => ['auth:manage']], function () {
        ...
        Route::group(['prefix' => 'system'], function () {
            ...
            Route::group(['prefix' => 'enterprise'], function () {
                ...
                Route::any('/', 'SystemEnterpriseController@index', ['model' => 'system', 'menu' => 'enterprise']);
            ...
            Route::group(['prefix' => 'user'], function () {
                ...
                Route::get('/list/{eid?}', 'SystemUserController@index', ['model' => 'system', 'menu' => 'user']);
 ...
 * 会员中心
 */
Route::group(['prefix' => 'member', 'middleware' => ['web'], 'namespace' => 'member'], function () {
